...
function Intro() {
    ...
    const specs = [
        ...
        { value: 'A18 Pro', label: 'Chip mais rápido do mundo!', color: 'text-orange-500' },

        { value: '49MP', label: 'Sistema de câmera', color: 'text-blue-600' },
    ...
    return (
        ...
        <section className="bg-black py-20 px-6">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <p className="text-2xl md:text-4xl mb-4 text-linear font-bold">Titânio. Tão forte. Tão leve. Tão Pro</p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mx-auto max-w-5xl">
                {specs.map( (spec, index) => (
                    <div key={index} className="bg-gray-900 rounded-2xl p-6 hover:bg-gray-800 transition-all duration-300 hover:scale-102 cursor-pointer">
